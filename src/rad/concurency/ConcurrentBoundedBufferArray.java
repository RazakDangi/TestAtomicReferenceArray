...
/**
 * CRUD operations thread safe and atomic on object type
 * similer to concurrent hash map
 * @author rdangi
 *
 * @param <T>
 */
	 ...
	 private T compareAndSwap(int i, T item) throws InvalidActivityException
	  {
	    ...
	    while (!set) {
	      ...
	      // or by some other element
	    	...
	    	if(t instanceof Razak && item instanceof Razak)
		      {
		    	  Razak r1=(Razak) t;
		    	  Razak r2= (Razak)item;
		    	  long diff=Math.abs(r1.getTime()-r2.getTime()) ;
